<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="DairyManager.Dashboard"
...
<%@ Register Src="~/DashboardTemplates/DairyVerticalAppointmentTemplate.ascx" TagName="DairyVerticalAppointment"
    TagPrefix="dva" %>
<%@ Register Src="~/DashboardTemplates/DairyHorizontalAppointmentTemplate.ascx" TagName="DairyHorizontalAppointment"
    TagPrefix="dva" %>
<%@ Register Src="~/DashboardTemplates/DairyHorizontalSameDayAppointmentTemplate.ascx"
    TagName="DairyHorizontalSameDayAppointment" TagPrefix="dva" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="overflow-table">
        <dxwschs:ASPxScheduler ID="Scheduler" runat="server" ActiveViewType="Month" OnBeforeExecuteCallbackCommand="ASPxScheduler1_BeforeExecuteCallbackCommand"
            ...
            <Views>
                ...
                <TimelineView Enabled="False">
                    ...
                    <AppointmentDisplayOptions AppointmentAutoHeight="True" EndTimeVisibility="Always"
                        StartTimeVisibility="Always" StatusDisplayType="Time" TimeDisplayType="Clock" />
            ...
            <OptionsForms AppointmentFormTemplateUrl="~/DevExpress/ASPxSchedulerForms/AppointmentForm.ascx"
                AppointmentFormVisibility="None" AppointmentInplaceEditorFormTemplateUrl="~/DevExpress/ASPxSchedulerForms/InplaceEditor.ascx"
                ...
                RecurrentAppointmentDeleteFormVisibility="None" RecurrentAppointmentEditFormTemplateUrl="~/DevExpress/ASPxSchedulerForms/RecurrentAppointmentEditForm.ascx"
                RecurrentAppointmentEditFormVisibility="None" RemindersFormTemplateUrl="~/DevExpress/ASPxSchedulerForms/ReminderForm.ascx" />
            <OptionsToolTips AppointmentDragToolTipUrl="~/DevExpress/ASPxSchedulerForms/AppointmentDragToolTip.ascx"
                ...
                SelectionToolTipUrl="~/DevExpress/ASPxSchedulerForms/SelectionToolTip.ascx" ShowAppointmentDragToolTip="False"
                AppointmentToolTipCornerType="Rounded" SelectionToolTipCornerType="Rounded" />
